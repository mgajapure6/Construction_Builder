    ...
    init:function() {
        $(".m_datatable").mDatatable( {
            data: {
                ...
                , pageSize:20, serverPaging:!0, serverFiltering:!0, serverSorting:!0
            }
            , layout: {
            ...
            , columns:[ {
                field:"RecordID", title:"#", locked: {
                    left: "xl"
                }
                , sortable:!1, width:40, selector: {
                    class: "m-checkbox--solid m-checkbox--brand"
                }
            }
            , {
                field:"Actions", width:110, title:"Actions", sortable:!1, locked: {
                    left: "xl"
                }
                , overflow:"visible", template:function(t, e, i) {
            ...
            , {
                field:"ShipAddress", title:"Ship Address", width:200, responsive: {
                    visible: "lg"
                }
            }
            , {
            ...
            , {
                field: "Notes", title: "Notes", width: 350
            }
            , {
            ...
            , {
                field:"Status", title:"Status", locked: {
                    left: "xl"
                }
                , width:100, template:function(t) {
                    var e= {
                        1: {
