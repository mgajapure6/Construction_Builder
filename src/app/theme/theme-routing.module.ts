...
const routes: Routes = [
    {
        ...
        "children": [
            {
                "path": "construct\/master\/project",
                "loadChildren": ".\/pages\/default\/construct\/master\/project\/project-master.module#ProjectMasterModule"
            },
            {
                "path": "construct\/master\/task",
                "loadChildren": ".\/pages\/default\/construct\/master\/task\/task-master.module#TaskMasterModule"
            },
            {
                "path": "construct\/master\/asset",
                "loadChildren": ".\/pages\/default\/construct\/master\/asset\/asset-master.module#AssetMasterModule"
            },
            {
                "path": "construct\/master\/contractor",
                "loadChildren": ".\/pages\/default\/construct\/master\/contractor\/contractor-master.module#ContractorMasterModule"
            },
            {
                "path": "construct\/master\/subcontractor",
                "loadChildren": ".\/pages\/default\/construct\/master\/subcontractor\/subcontractor-master.module#SubContractorMasterModule"
            },
            {
                "path": "construct\/master\/supplier",
                "loadChildren": ".\/pages\/default\/construct\/master\/supplier\/supplier-master.module#SupplierMasterModule"
            },
            {
                "path": "construct\/master\/employee",
                "loadChildren": ".\/pages\/default\/construct\/master\/employee\/employee-master.module#EmployeeMasterModule"
            },
